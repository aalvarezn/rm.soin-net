...
<body class="four-zero-four">
	<div class="four-zero-four-container">
		<div class="error-code" style="font-size: 100px; margin-top: 15px;">EN
			CONSTRUCCION</div>
		<div class="error-message" style="margin-top: 15px;">EL SITIO
			ESTARA LISTO PRONTO</div>

		<div class="container" style="margin-top: 15px;">
			<div class="body">

				<div class="progress">
					<div class="progress-bar bg-cyan progress-bar-striped active"
						role="progressbar" aria-valuenow="73" aria-valuemin="0"
						aria-valuemax="100" style="width: 73%">73%</div>
				</div>
			</div>
		</div>
