...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/typeObject/typeObjectModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">TIPO OBJETOS</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<tbody>
								<c:forEach items="${typeObjects}" var="typeObject">
									<tr id="${typeObject.id}">
										<td>${typeObject.name}</td>
										<td>${typeObject.description}</td>
										<td>${typeObject.system.code}</td>
										<td><div class="iconLineC">
												<a onclick="updateTypeObjectModal(${typeObject.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteTypeObject(${typeObject.id})"><i
		...
		<a id="buttonAddTypeObject" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openTypeObjectModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/typeObject.js?v=${jsVersion}'/>"></script>
