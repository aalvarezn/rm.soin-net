...
<div class="modal fade" id="typeObjectModal" tabindex="-1" role="dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row clearfix">
					<form id="typeObjectModalForm" action="">
						<input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}" /> <input type="hidden" id="typeObjectId"
							value="" />
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default waves-effect"
					onclick="closeTypeObjectModal()">CANCELAR</button>
				<button id="btnSaveTypeObject" type="button"
					class="btn btn-primary waves-effect" onclick="saveTypeObject()">GUARDAR</button>
				<button id="btnUpdateTypeObject" type="button"
					class="btn btn-primary waves-effect" onclick="updateTypeObject()">ACTUALIZAR</button>
			</div>
		</div>
	</div>
</div>
