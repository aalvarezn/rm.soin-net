...
<div class="modal fade" id="statusIncidenceModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="largeModalLabel">Estado Incidencia</h4>
			</div>
			<div class="modal-body">
				<form id="statusIncidenceModalForm" action="">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default waves-effect"
					onclick="closeStatusIncidence()">CANCELAR</button>
				<button id="save" type="button" class="btn btn-primary waves-effect"
					onclick="saveStatusIncidence()">GUARDAR</button>
				<button id="update" type="button"
					class="btn btn-primary waves-effect" onclick="updateStatusIncidence()">ACTUALIZAR</button>
			</div>
		</div>
	</div>
</div>
