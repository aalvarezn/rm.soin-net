...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/authority/authorityModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">ROLES</h2>
					</div>
					<hr>
				</div>
			</div>
								...
								<c:forEach items="${authoritys}" var="authority">
									<tr id="${authority.id}">
										...
										<td><div class="iconLineC">
												<a onclick="updateAuthorityModal(${authority.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteAuthority(${authority.id})"><i
		...
		<a id="buttonAddAuthority" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openAuthorityModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/authority.js?v=${jsVersion}'/>"></script>
