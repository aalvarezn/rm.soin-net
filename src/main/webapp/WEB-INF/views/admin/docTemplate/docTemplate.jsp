...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/docTemplate/docTemplateModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">PLANTILLAS RELEASE</h2>
					</div>
					<hr>
				</div>
			</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="table-responsive m-b-20">
						<table
							...
							<tbody>
								<c:forEach items="${docTemplates}" var="docTemplate">
									<tr id="${docTemplate.id}">
										<td>${docTemplate.name}</td>
										<td>${docTemplate.templateName}</td>
										<td>${docTemplate.componentGenerator}</td>
										<td>${docTemplate.sufix}</td>
										<td>${docTemplate.system.code}</td>
										<td><div class="iconLineC">
												<a onclick="updateDocTemplateModal(${docTemplate.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteDocTemplate(${docTemplate.id})"><i
		...
		<a id="buttonAddDocTemplate" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openDocTemplateModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/docTemplate.js?v=${jsVersion}'/>"></script>
