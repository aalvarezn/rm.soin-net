...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/impact/impactModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">IMPACTO</h2>
					</div>
					<hr>
				</div>
			</div>
								...
								<c:forEach items="${impacts}" var="impact">
									<tr id="${impact.id}">
										...
										<td><div class="iconLineC">
												<a onclick="updateImpactModal(${impact.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteImpact(${impact.id})"><i
		...
		<a id="buttonAddImpact" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openImpactModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/impact.js?v=${jsVersion}'/>"></script>
