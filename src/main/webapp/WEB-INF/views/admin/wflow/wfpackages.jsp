...
<body class="theme-grey">
	...
	<section>
		<!-- UserModal -->
		<%@include file="../../admin/wflow/packageModal.jsp"%>
		<!-- #END# UserModal -->
	</section>
	...
	<section class="content m-t-80I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">PAQUETES</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<thead>
								<tr>
									<th>Nombre</th>
									<th>Descripción</th>
									<th class="actCol" style="text-align: center;">Acción</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${wfpackageList}" var="wfpackage">
									<tr id="${wfpackage.id}">
										<td>${wfpackage.name}</td>
										<td>${wfpackage.description}</td>
										<td>
											<div style="text-align: center">
												<i onClick="editwfpackageModal(${wfpackage.id})"
													class="material-icons gris" style="font-size: 30px">edit</i>
												<i onClick="return true;" class="material-icons gris"
		...
		<a id="buttonWflow" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openwfpackageModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script src="<c:url value='/static/js/wflow/wflow.js'/>"></script>
	<script
