...
<body class="theme-grey">
	...
	<section>
		<!-- UserModal -->
		<%@include file="../../admin/wflow/nodeModal.jsp"%>
		<!-- #END# UserModal -->
	</section>
	...
	<section class="content m-t-80I">
		<div class="container-fluid">
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">DEFINIR FLUJO</h2>
					</div>
					<hr>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div id="mynetwork" class="wfl"></div>
				</div>
			</div>
		</div>
		<a id="buttonAddUser" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="return trueñ"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script src="<c:url value='/static/js/wflow/wflowvis.js'/>"></script>
</body>
