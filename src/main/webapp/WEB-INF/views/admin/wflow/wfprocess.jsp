...
<body class="theme-grey">
	...
	<section>
		<!-- UserModal -->
		<%@include file="../../admin/wflow/createWFModal.jsp"%>
		<!-- #END# UserModal -->
	</section>
	...
	<section class="content m-t-80I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">PROCESOS</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<tbody>
								<c:forEach items="${wfprocessList}" var="wfprocess">
									<tr>
										<td>${wfprocess.name}</td>
										<td>${wfprocess.system.code}</td>
										<td>${wfprocess.version}</td>
										<td>${wfprocess.publicationstatus}</td>
										<td>${wfprocess.user.username}</td>
										<td>
											<div style="text-align: center">
												<i onClick="return true;" class="material-icons gris"
													style="font-size: 30px">edit</i> <i onClick="return true;"
		...
		<a id="buttonWflow" type="button"
			...
			onclick="createWflowModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
