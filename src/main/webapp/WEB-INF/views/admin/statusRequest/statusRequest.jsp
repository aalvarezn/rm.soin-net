...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/statusRequest/statusRequestModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">Estado Solicitud</h2>
					</div>
					<hr>
				</div>
			</div>
		...
		<a id="buttonAddSiges" type="button"
			...
			onclick="addStatusRequest()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<!-- #END# Script Section -->
	<script
		src="<c:url value='/static/js/admin/statusRequest.js'/>"></script>
