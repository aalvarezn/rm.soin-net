...
<div class="modal fade" id="priorityIncidenceModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="largeModalLabel">Prioridad de incidencia</h4>
			</div>
							...
							<div class="form-group">
								<div class="form-line">
									<input type="text" class="form-control" id="sCode"
										maxlength="50" name="sCode" placeholder="Ingrese un nombre"
										style="height: 60px;">
			...
			<div class="modal-footer">
				...
				<button id="update" type="button"
					class="btn btn-primary waves-effect" onclick="updatePriorityIncidence()">ACTUALIZAR</button>
			</div>
		</div>
	</div>
</div>
