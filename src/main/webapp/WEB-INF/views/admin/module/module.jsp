...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/module/moduleModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">MODULOS</h2>
					</div>
					<hr>
				</div>
			</div>
							...
							<tbody>
								<c:forEach items="${modules}" var="module">
									<tr id="${module.id}">
										...
										<td>${module.system.code}</td>
										<td><div class="iconLineC">
												<a onclick="updateModuleModal(${module.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteModule(${module.id})"><i
		...
		<a id="buttonAddModule" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openModuleModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/module.js?v=${jsVersion}'/>"></script>
