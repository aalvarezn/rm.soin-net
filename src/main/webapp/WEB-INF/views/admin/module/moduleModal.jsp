		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row clearfix">
					<form id="moduleModalForm" action="">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default waves-effect"
					onclick="closeModuleModal()">CANCELAR</button>
				<button id="btnSaveModule" type="button"
					class="btn btn-primary waves-effect" onclick="saveModule()">GUARDAR</button>
				<button id="btnUpdateModule" type="button"
					class="btn btn-primary waves-effect" onclick="updateModule()">ACTUALIZAR</button>
			</div>
		</div>
	</div>
</div>
