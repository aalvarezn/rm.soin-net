...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/docFile/docFileModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">PLANTILLAS ARCHIVOS</h2>
					</div>
					<hr>
				</div>
			</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="table-responsive m-b-20">
						<table
							...
							<tbody>
								<c:forEach items="${docFiles}" var="docFile">
									<tr>
										<td>${docFile.key}.${docFile.value}</td>
										<td><div class="iconLineC">
												<a
													href="<c:url value='/admin/docFile/download/${docFile.key}/${docFile.value}'/>"
													download="" class=""> <i class="material-icons gris"
													style="font-size: 30px;">cloud_download</i>
												</a> <a onclick="confirmDeleteDocFile('${docFile.key}', '${docFile.value}')"><i
		...
		<a id="buttonAddDocFile" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openDocFileModal()"> <i class="material-icons lh-1-8">backup</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/docFile.js?v=${jsVersion}'/>"></script>
