...
<body class="theme-grey">
	...
	<section class="content m-t-90I">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="table-responsive m-b-20">
						<table
							...
							<tbody>
								<c:forEach items="${gDocs}" var="gDoc">
									<tr id="${gDoc.id}">
										<td>${gDoc.description}</td>
										<td>${gDoc.proyect.code}</td>
										<td><div class="iconLineC">
												<a onclick="updateGDocModal(${gDoc.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteGDoc(${gDoc.id})"><i
		...
		<a id="buttonAddGDoc" type="button"
			...
			onclick="openGDocModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/gDoc.js?v=${jsVersion}'/>"></script>
