...
<body class="theme-grey">
	...
	<section>
		<!-- typeAmbientModal -->
		<%@include file="../../admin/typeAmbient/typeAmbientModal.jsp"%>
		<!-- #END# typeAmbientModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">TIPO DE AMBIENTE</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<tbody>
								<c:forEach items="${typeAmbients}" var="typeAmbient">
									<tr id="${typeAmbient.id}">
										<td>${typeAmbient.name}</td>
										<td>${typeAmbient.description}</td>
										<td><div class="iconLineC">
												<a onclick="updateTypeAmbientModal(${typeAmbient.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteTypeAmbient(${typeAmbient.id})"><i
		...
		<a id="buttonAddTypeAmbient" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openTypeAmbientModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script src="<c:url value='/static/js/admin/typeAmbient.js?v=${jsVersion}'/>"></script>
