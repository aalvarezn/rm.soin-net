...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/environment/environmentModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">ENTORNOS</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<thead>
								<tr>
									...
									<th>Descripción</th>
									<th>Sistema</th>
									<th class="actCol" style="text-align: center;">Externo</th>
							...
							<tbody>
								<c:forEach items="${environments}" var="environment">
									<tr id="${environment.id}">
										...
										<td>${environment.system.code}</td>
										<td><div class="iconLine align-center">
												<c:if test="${!environment.external}">
													<i class="material-icons gris" style="font-size: 30px;">cancel</i>
												</c:if>
												<c:if test="${environment.external}">
													<i class="material-icons gris" style="font-size: 30px;">check_circle</i>
												</c:if>
											</div></td>
										<td><div class="iconLineC">
												<a onclick="updateEnvironmentModal(${environment.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteEnvironment(${environment.id})"><i
		...
		<a id="buttonAddEnvironment" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openEnvironmentModal()"> <i
	...
	<script
		src="<c:url value='/static/js/admin/environment.js?v=${jsVersion}'/>"></script>
