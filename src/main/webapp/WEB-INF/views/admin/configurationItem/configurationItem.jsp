...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../admin/configurationItem/configurationItemModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">ITEMS DE CONFIGURACIÓN</h2>
					</div>
					<hr>
				</div>
			</div>
						...
						<table
							...
							<tbody>
								<c:forEach items="${configurationItems}" var="configurationItem">
									<tr id="${configurationItem.id}">
										<td>${configurationItem.name}</td>
										<td>${configurationItem.description}</td>
										<td>${configurationItem.system.code}</td>
										<td><div class="iconLineC">
												<a onclick="updateConfigurationItemModal(${configurationItem.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteConfigurationItem(${configurationItem.id})"><i
		...
		<a id="buttonAddConfigurationItem" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openConfigurationItemModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script
		src="<c:url value='/static/js/admin/configurationItem.js?v=${jsVersion}'/>"></script>
