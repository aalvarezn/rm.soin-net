						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<h5 class="rel_num">
								<span>Ticket: </span>${incidence.numTicket} <input type="hidden"
									id="rfcId" value="${incidence.id}"> <input
									type="hidden" id="rfcNumber" value="${incidence.numTicket}">
								<input type="hidden" id="systemInfoId"
									value="${rfc.systemInfo.id}">
							...
							<div class="wizard">
								<div class="wizard-inner">
									...
									<ul class="nav nav-tabs stepper" role="tablist">
										...
										<li id="2" role="presentation" class="without-line "
											style="margin-left: 22%;"><a href="#step2"
											data-toggle="tab" aria-controls="step2" role="tab" title="">
												<span class="round-tab"> 2 </span> <span id="step2Errors"
												style="visibility: hidden;" class="labelCount_Error"><i
													class="material-icons spanError">warning</i></span>
										</a></li>
										<li id="3" role="presentation" class="without-line "
											style="margin-left: 25%;"><a href="#step3"
											data-toggle="tab" aria-controls="step3" role="tab" title="">
												<span class="round-tab"> 3 </span> <span id="step3Errors"
												style="visibility: hidden;" class="labelCount_Error"><i
													class="material-icons spanError">warning</i></span>
										</a></li>
									</ul>
								...
								<div class="tab-content">
									...
									<div class="tab-pane animated fadeIn active" role="tabpanel"
										...
										<div class="body">
											<%@include
												file="../incidence/sectionsEditIncidence/section_1.jsp"%>
										</div>
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										...
										<div class="body">
											<%@include
												file="../incidence/sectionsEditIncidence/section_4.jsp"%>
										</div>
										<div class="button-demo flr">
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										...
										<div class="body">
											<%@include
												file="../incidence/sectionsEditIncidence/section_5.jsp"%>
										...
										<div class="button-demo flr">
											...
											<c:forEach items="${userInfo.authorities}" var="authority">
												<c:if test="${authority.name == 'Incidencias'}">
													<button id="applyFor" onclick="requestIncidence()"
														type="button" class="btn btn-primary">SOLICITAR</button>

												</c:if>
												<c:if test="${authority.name == 'Gestion Incidencias'}">
													<button id="applyFor" onclick="atendIncidence()"
														type="button" class="btn btn-primary">ATENDER</button>
												</c:if>
											</c:forEach>
