							...
							<h5 class="rel_num">
								<span>RFC: </span>${baseKnowledge.numError} <input type="hidden"
									...
									id="rfcNumber" value="${baseKnowledge.numError}">
									 <input type="hidden"
									id="componentId" value="${baseKnowledge.component.id}">
							...
							<div class="wizard">
								<div class="wizard-inner">
									...
									<ul class="nav nav-tabs stepper" role="tablist">
										...
										<li id="2" role="presentation" class="without-line " style="margin-left: 20%;"><a
										...
										<li id="3" role="presentation" class="without-line " style="margin-left: 20%;"><a
								...
								<div class="tab-content">
									...
									<div class="tab-pane animated fadeIn active" role="tabpanel"
										id="step1">
										<div class="body">
											<%@include file="../../incidence/baseKnowledge/sectionsEditBaseKnowledge/section_1.jsp"%>
										</div>
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										id="step2">
										<div class="body">
											<%@include file="../../incidence/baseKnowledge/sectionsEditBaseKnowledge/section_2.jsp"%>
										</div>
										<div class="button-demo flr">
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										id="step3">
										<div class="body">
											<%@include file="../../incidence/baseKnowledge/sectionsEditBaseKnowledge/section_3.jsp"%>
										</div>
