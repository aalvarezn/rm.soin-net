...
<body class="theme-grey">
		...
		<div class="container-fluid">
			<div class="row clearfix">
				<div class="button-demo flr">
					<a href="<c:url value='/'/> " class="btn btn-default"> REGRESAR</a>
				</div>
			</div>
			...
			<div class="row clearfix">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="releaseNumber"
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="system" name="system"
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="user" name="user"
			...
			<div class="row clearfix m-t-10">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="status" name="status"
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="impact" name="impact"
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="risk" name="risk"
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					...
					<div class="form-group m-b-0i">
						<div class="form-line disabled">
							<input type="text" disabled id="priority" name="priority"
				...
				<c:if test="${systemConfiguration.applicationVersion}">
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						...
						<div class="form-group m-b-0i">
							<div class="form-line disabled">
								<input type="text" disabled id="versionNumber"
			...
			<c:if test="${systemConfiguration.instalationData}">
				<div class="row clearfix m-t-10">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea disabled="disabled" rows="2" cols=""
									class="form-control" placeholder="No Aplica." style="">${release.installation_instructions}</textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea disabled="disabled" rows="2" cols=""
									class="form-control" placeholder="No Aplica." style="">${release.verification_instructions}</textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 m-t-10">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea disabled="disabled" rows="2" cols=""
									class="form-control" placeholder="No Aplica." style="">${release.rollback_plan}</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix m-t-10">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group">
							<div class="form-line">
								<textarea disabled="disabled" rows="2" cols=""
									id="certRollbackPlan" class="form-control"
									placeholder="No Aplica" style="">${release.certRollbackPlan}</textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group ">
							<div class="form-line">
								<textarea disabled="disabled" rows="2" cols=""
									id="prodRollbackPlan" class="form-control"
									placeholder="No Aplica" style="">${release.prodRollbackPlan}</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix m-t-10">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea rows="2" cols="" class="form-control"
									placeholder="No Aplica." style="">${release.observationsProd}</textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea rows="2" cols="" class="form-control"
									placeholder="No Aplica." style="">${release.observationsPreQa}</textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-t-20">
						...
						<div class="form-group m-b-0i">
							<div class="form-line">
								<textarea rows="2" cols="" class="form-control"
									placeholder="No Aplica." style="">${release.observationsQa}</textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<!-- 							<i class="material-icons">extension</i> <span>EXTENSION</span> -->
				<!-- 						</button> -->
				<!-- 						<button type="button" class="btn btn-success waves-effect"> -->
				<!-- 							<i class="material-icons">home</i> <span>HOME</span> -->
				<!-- 						</button> -->
				<!-- 						<button type="button" class="btn btn-info waves-effect"> -->
				<!-- 							<i class="material-icons">lock</i> <span>LOCK</span> -->
				<!-- 						</button> -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#contentSummary input").attr("disabled", true);
