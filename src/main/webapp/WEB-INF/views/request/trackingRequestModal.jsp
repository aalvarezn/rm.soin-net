...
<div class="modal fade" id="trackingRequestModal" tabindex="-1"
	role="dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row clearfix">
					<form id="trackingRequestForm" action="">
						<input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}" /> <input type="hidden" id="idRequest"
							value="" />

						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<label id="requestNumber" class="col-cyan">Número Solicitud</label>
						</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default waves-effect"
					onclick="closeTrackingRequestModal()">SALIR</button>
			</div>
		</div>
	</div>
</div>