...
<body class="theme-grey">
	...
	<section>
		...
		<!-- addObjectModal -->
		<%@include file="../request/sectionsEditR3/previewRequestModal.jsp"%>
		<!-- #END# addObjectModal -->
							...
							<div class="wizard">
								...
								<div class="tab-content">
									...
									<div class="tab-pane animated fadeIn active" role="tabpanel"
										id="step1">
										<div class="body">
											<%@include file="../request/sectionsEditR3/section_1.jsp"%>
										</div>
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										id="step2">
										<div class="body">
											<%@include file="../request/sectionsEditR3/section_2.jsp"%>
										</div>
									...
									<div class="tab-pane animated fadeIn" role="tabpanel"
										id="step3">
										<div class="body">
											<%@include file="../request/sectionsEditR3/section_3.jsp"%>
										</div>
										<div class="button-demo flr p-t-20">
