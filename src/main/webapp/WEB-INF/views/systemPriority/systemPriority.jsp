...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../systemPriority/systemPriorityModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">Prioridad de ticket por Sistemas </h2>
					</div>
					<hr>
				</div>
			</div>
	...
	<!-- #END# Script Section -->
	<script
		src="<c:url value='/static/js/systemPriority/systemPriority.js'/>"></script>
