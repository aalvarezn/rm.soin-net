					...
					<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 m-b-10">
						...
						<div id="listSystems">
							<ul class="nav nav-pills">
								<li class="nav-item dependency m-r-10">${codeSiges.system.name}
								</li>
								<c:if test="${rfc.releases}!=null">
									<c:forEach items="${rfc.releases}" var="release">
										<c:if test="${release.system.name}!=${codeSiges.system.name}">
