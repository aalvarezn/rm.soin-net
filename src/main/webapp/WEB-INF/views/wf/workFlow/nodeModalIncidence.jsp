						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<ul class="nav nav-tabs tab-nav-right" role="tablist">
								...
								<li role="presentation"><a href="#tabActors"
									data-toggle="tab">GRUPOS ACTORES</a></li>
								
								<li role="presentation"><a href="#tabSecurity"
									data-toggle="tab">GRUPOS A NOTIFICAR</a></li>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									...
									<div class="form-group m-t-25">
										<select id="statusId"
											...
											<c:forEach items="${statuses}" var="test">
												<option value="${test.id }">${test.status.name }</option>
											</c:forEach>
										</select>
									</div>
								</div>
