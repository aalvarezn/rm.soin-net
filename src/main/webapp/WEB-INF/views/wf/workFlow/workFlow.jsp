...
<body class="theme-grey">
	...
	<section>
		<!-- 		workFlowModal -->
		<%@include file="../../wf/workFlow/createWorkFlowModal.jsp"%>
		<!-- 		#END# workFlowModal -->
	</section>
	...
	<section class="content m-t-90I">
								...
								<c:forEach items="${workFlows}" var="workFlow">
									<tr id="${workFlow.id}">
										...
										<td><div class="iconLineC">
												...
												<a onclick="confirmDeleteWorkFlow(${workFlow.id})"><i
		...
		<a id="buttonAddWorkFlow" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openWorkFlowModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script src="<c:url value='/static/js/wf/workFlow.js?v=${jsVersion}'/>"></script>
