...
<body class="theme-grey">
	...
	<section>
		<!-- EmailModal -->
		<%@include file="../../wf/type/typeModal.jsp"%>
		<!-- #END# EmailModal -->
	</section>
	...
	<section class="content m-t-90I">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="" style="padding-top: -5pc;">
						<h2 class="title-Adm m-t-0">TIPOS</h2>
					</div>
					<hr>
				</div>
			</div>
								...
								<c:forEach items="${types}" var="type">
									<tr id="${type.id}">
										...
										<td><div class="iconLineC">
												<a onclick="updateTypeModal(${type.id})"><i
													class="material-icons gris" style="font-size: 30px;">mode_edit</i></a>

												<a onclick="confirmDeleteType(${type.id})"><i
		...
		<a id="buttonAddType" type="button"
			class="btn btn-primary btn-fab waves-effect fixedDown"
			onclick="openTypeModal()"> <i class="material-icons lh-1-8">add</i>
		</a>
	</section>
	...
	<script src="<c:url value='/static/js/wf/type.js?v=${jsVersion}'/>"></script>
