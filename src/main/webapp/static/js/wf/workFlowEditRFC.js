...
function loadWorkFlow() {
	$.ajax({
		type : "GET",
		url : getCont() + "wf/workFlow/" + "loadWorkFlowRFC/"
		+ $("#wfEdit").data("id"),
		timeout : 60000,
		data : {},
...
function saveNode(nodeData, callback) {
	$.ajax({
		type : "POST",
		url : getCont() + "wf/workFlow/" + "saveNodeRFC",
		data : {
			id : 0,
...
function deleteNode(element, callback) {
	$.ajax({
		type : "DELETE",
		url : getCont() + "wf/workFlow/" + "deleteNodeRFC/" + element,
		timeout : 60000,
		data : {},
		success : function(response) {
...
function updateNodeModal() {
	...
	$.ajax({
		type : "POST",
		url : getCont() + "wf/workFlow/" + "updateNodeRFC",
		data : {
...
function updateNodePosition(nodeId, params) {
	...
	if (typeof node.id !== 'undefined') {
		$.ajax({
			type : "POST",
			url : getCont() + "wf/workFlow/" + "updateNodeRFCPosition",
			data : {
				id : node.id,
				workFlowId : $("#wfEdit").data("id"),
				x : position.x,
...
function saveEdge(edgeData, callback) {
	$.ajax({
		type : "POST",
		url : getCont() + "wf/workFlow/" + "saveEdgeRFC",
		data : {
			id : 0,
...
function deleteEdge(element) {
	$.ajax({
		type : "DELETE",
		url : getCont() + "wf/workFlow/" + "deleteEdgeRFC/" + element,
		timeout : 60000,
		data : {},
		success : function(response) {
