...
$(function() {
	...
	function initTableObject() {
		console.log();
		//console.log( getCont());
		$dtObjects = $('#tableTest6').DataTable(
				{
					...
					lengthMenu : [ [ 10, 25, 50, -1 ],
						...
						"processing" : true,
						"serverSide" : true,
						"sAjaxSource" : window.location.pathname.substring(0, window.location.pathname
								.indexOf("/", 2)) + "/release/listObjects",
	...
	function initTableObject2() {
		...
		$dtObjects2 = $('#tableTest7').DataTable(
				{
