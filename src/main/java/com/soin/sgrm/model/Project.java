...
public class Project implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PROYECTOS_PROYECTO_SQ")
	@SequenceGenerator(name = "PROYECTOS_PROYECTO_SQ", sequenceName = "PROYECTOS_PROYECTO_SQ", allocationSize = 1)
	@Column(name = "ID")
	private int id;
