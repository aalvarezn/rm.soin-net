...
public class ErrorController {
	...
	public String renderErrorPage(HttpServletResponse response, HttpServletRequest httpRequest, Locale locale,
		...
		if (errorType == null) {
			errorType = (String) ((httpRequest.getAttribute("errorType") == null) ? ""
					: httpRequest.getAttribute("errorType"));
		}
