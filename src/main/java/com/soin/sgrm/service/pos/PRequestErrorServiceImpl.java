...
@Service("PRequestErrorService")
public class PRequestErrorServiceImpl  implements PRequestErrorService{
	@Autowired
	PRequestErrorDao dao;
	
	@Override
	public PRequestError findById(Long id) {
		
		return dao.getById(id);
	}

	@Override
	public PRequestError findByKey(String name, String value) {
	
		return dao.getByKey(name, value);
	}

	@Override
	public List<PRequestError> findAll() {
		
		return dao.findAll();
	}

	@Override
	public void save(PRequestError model) {
		dao.save(model);
	}

	@Override
	public void delete(Long id) {
		PRequestError model=findById(id);
		dao.delete(model);
	}

	@Override
	public void update(PRequestError model) {
		dao.update(model);
	}

	@Override
	public JsonSheet<PRequestError> findAll(Integer sEcho, Integer iDisplayStart, Integer iDisplayLength, String sSearch,
	...
	@Override
	public List<PRequestError> findAllList(Long errorId, String dateRange, Long typePetitionId, int systemId) {
		Map<String, Object> columns = new HashMap<String, Object>();
