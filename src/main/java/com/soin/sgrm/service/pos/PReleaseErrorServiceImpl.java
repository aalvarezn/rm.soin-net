...
import com.soin.sgrm.dao.pos.PReleaseErrorDao;
import com.soin.sgrm.model.pos.PReleaseError;
import com.soin.sgrm.response.JsonSheet;

@Transactional("transactionManagerPos")
@Service("PReleaseErrorService")
public class PReleaseErrorServiceImpl  implements PReleaseErrorService{
	@Autowired
	PReleaseErrorDao dao;
	
	@Override
	public PReleaseError findById(Long id) {
		
		return dao.getById(id);
	}

	@Override
	public PReleaseError findByKey(String name, String value) {
	
		return dao.getByKey(name, value);
	}

	@Override
	public List<PReleaseError> findAll() {
		
		return dao.findAll();
	}

	@Override
	public void save(PReleaseError model) {
		dao.save(model);
	}

	@Override
	public void delete(Long id) {
		PReleaseError model=findById(id);
		dao.delete(model);
	}

	@Override
	public void update(PReleaseError model) {
		dao.update(model);
	}

	@Override
	public JsonSheet<PReleaseError> findAll(Integer sEcho, Integer iDisplayStart, Integer iDisplayLength, String sSearch,
	...
	@Override
	public List<PReleaseError> findAllList(Long errorId, String dateRange, int projectId, int systemId) {
		Map<String, Object> columns = new HashMap<String, Object>();
