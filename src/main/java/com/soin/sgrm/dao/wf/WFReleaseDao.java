...
public interface WFReleaseDao {
	...
	JsonSheet<?> listWorkFlowManager(String name, int sEcho, int iDisplayStart, int iDisplayLength, String sSearch,
			String[] filtred, String[] dateRange, Integer systemId, Integer statusId, List<Integer> listIdRelease, Integer userId) throws SQLException, ParseException;
	
	void wfStatusRelease(WFRelease release);
	
	Integer countByType(String group, List<Integer> listIdRelease, Integer userId);
